...
const ScanningTips = ({ className, defaultExpanded = false }: ScanningTipsProps) => {
  ...
  return (
    <div className={cn('rounded-xl border border-accent/20 bg-accent/5 overflow-hidden', className)}>
      <button
