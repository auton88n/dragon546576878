      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 text-accent mb-4">
              ...
              <span className="text-sm font-medium uppercase tracking-wider">
                {currentLanguage === 'ar' ? 'قصتنا' : 'Our Story'}
              </span>
            </div>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-foreground leading-relaxed">
              <span className="block">{t('about.story.titleAr')}</span>
              <span className="block text-accent mt-2">{t('about.story.titleEn')}</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            {/* Arabic Content */}
            <div className="glass-card-gold p-8 md:p-10" dir="rtl">
              <p className="text-foreground/80 leading-loose text-base md:text-lg font-arabic">
              ...
              <p className="text-foreground/80 leading-loose text-base md:text-lg font-arabic mt-6">
            ...
            {/* English Content */}
            <div className="glass-card-gold p-8 md:p-10" dir="ltr">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-foreground">
                <span className="block">{currentLanguage === 'ar' ? 'رؤيتنا' : 'Our Vision'}</span>
              </h2>
            </div>

            <div className="glass-card-gold p-8 md:p-12 text-center">
              {/* Arabic Vision */}
              <p className="text-foreground/80 leading-loose text-base md:text-lg font-arabic mb-8" dir="rtl">
              ...
              {/* English Vision */}
              <p className="text-foreground/80 leading-loose text-base md:text-lg mb-8" dir="ltr">
              ...
              <p className="text-foreground/80 leading-loose text-base md:text-lg" dir="ltr">
              ...
              <div className="mt-10 inline-flex items-center gap-3 bg-accent/10 px-6 py-3 rounded-full">
                ...
                <span className="text-foreground/70 text-sm">
                  {currentLanguage === 'ar' ? 'رؤية المملكة' : 'Saudi Vision'}
                </span>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-foreground to-foreground/90">
        <div className="container text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-background mb-6">
            {currentLanguage === 'ar' ? 'ابدأ رحلتك التراثية' : 'Start Your Heritage Journey'}
          </h2>
